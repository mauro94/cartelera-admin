...
export class DateSinglePicker extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            date: moment(props.values[props.field.name]) || moment()
        }
    ...
    handleChange(date) {
        this.props.updateFormik(this.props.field.name, date.format(), this.props.setFieldValue, this.props.setTouched, this.props.touched)
